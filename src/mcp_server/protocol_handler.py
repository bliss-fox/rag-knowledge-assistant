...
def create_mcp_server(
    ...
    # A supplied handler is treated as an intentional custom registry.  Only
    # populate defaults when the registry is empty, avoiding duplicate names
    # and surprising mutation of pre-configured handlers.
