...
All files under `.agents/skills/auto-coder/references/`:
...
- Read `.agents/skills/auto-coder/references/06-schedule.md`
...
1. **Read relevant spec** from `.agents/skills/auto-coder/references/`:
